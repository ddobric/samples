...
namespace QueueCRUD
{
    ...
    public class Program 
    {
        ...
        public async Task RunAsync(string connectionString)
        {
            ...
            await ListQueues(queueName).ConfigureAwait(false);
        ...
        private async Task ListQueues(string containsName)
        {
            var queues = await this.managementClient.GetQueuesAsync(5);            
        }
        ...
        public static int Main(string[] args)
        {
            ...
            {
                var app = new Program();
                app.RunAsync("Endpoint=sb://igniteberlin.servicebus.windows.net/;SharedAccessKeyName=samplerootkey;SharedAccessKey=v6yAqaJhCU0JK9LvaYBjsuwJVse/tAaVV8BgxK0G8lk=").Wait();
            }
            catch (Exception e)
            {
