...
namespace GuestBook_Data
{
    ...
    {
        #region Credentials
        private static string m_AccKey = "6L+72abrlqlDmhOhacxMCdXKXJi3ySerNB/7j98WOusz8jMjxsiR6geKgbuZq4yK+lZMfUe+vTfjwByJotfTkA==";
        private static string m_AccName = "frankfurt";
        #endregion
        ...
        public void DeleteEntries(ICollection<GuestBookEntry> deletingIds)
        {
            var table = getTableClient();
